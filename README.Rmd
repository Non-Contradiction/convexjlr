...
Note: if you have the latest Julia version (v0.6.0) installed, then you have to use the
latest version of `XRJulia`, which is a dependency of `convexjlr` package.
...
To use package `convexjlr`, we first need to attach it and do the initial setip:
